; $Id: setup_8580.asm 1164 2014-05-28 19:27:40Z tk $
	LIST R=DEC
;
...
CS_MENU_DIN_TABLE
	...
	DIN_ENTRY	CS_MENU_BUTTON_Exec,	 1,	 7
	...
	DIN_ENTRY	CS_MENU_BUTTON_Sel5,	 1,	 2
	...
	DIN_ENTRY	CS_MENU_BUTTON_CC_PageUp, 2,    2	; combined CC/PageUp -- CC actived together with shift button (no error)
	DIN_ENTRY	CS_MENU_BUTTON_Edit_PageDown, 2, 1	; combined Edit/PageDown -- Edit actived together with shift button (no error)

	DIN_ENTRY	CS_MENU_BUTTON_SID1,	 2,      3
	DIN_ENTRY	CS_MENU_BUTTON_SID2,	 2,      0
...
CS_MENU_DOUT_TABLE
	...
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 0,		1,	1	; SID1 LED (Note: Pin #0 is the D7 output of first SR)
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 1,		1,	2	; SID2 LED
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 2,		1,	5	; SID3 LED
	DOUT_ENTRY	CS_MENU_SELECTED_SID_FLAGS, 3,		1,	6	; SID4 LED

	DOUT_ENTRY	CS_MENU_MODE, 0,			1,	0	; Shift LED
	DOUT_ENTRY	CS_MENU_MODE, 1,			1,	3	; CC LED
	DOUT_ENTRY	CS_MENU_MODE, 4,			1,	4	; Edit LED
